#
# Module manifest for module 'PSDevOpsBackup'
#
...
@{
    ...
    RootModule = 'PSDevOpsBackup.psm1'

    # Version number of this module.
    ModuleVersion = '1.0.0.1'

    # ID used to uniquely identify this module
    GUID = '6117e7a6-10a4-4953-be8b-2d7cea46f64b'
    ...
    Description = 'PowerShell module for backup DevOps repos.'
    ...
    FunctionsToExport = @('Backup-Repository','Backup-Pipeline','Backup-Release','Backup-VariableGroup')
    ...
    FileList = @('PSDevOpsBackup.psd1','PSDevOpsBackup.psm1',
        'Backup-Repository.ps1','Backup-Pipeline.ps1','Backup-Release.ps1','Backup-VariableGroup.ps1')
    ...
    PrivateData = @{
        ...
        PSData = @{
            ...
            LicenseUri = 'https://github.com/mgajda83/PSDevOpsBackup/blob/main/LICENSE'

            # A URL to the main website for this project.
            ProjectUri = 'https://github.com/mgajda83/PSDevOpsBackup'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBnlT6i1PYl28aj
# NpKweTxMxWuR/Pb+69iH4RytoYHAYaCCJnowggXJMIIEsaADAgECAhAbtY8lKt8j
...
# MQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgHEWpQqy0IfVX1BKcmhEk
# xZKJ7d1uNhVgzstWNjAtPPgwDQYJKoZIhvcNAQEBBQAEggIAlewQTVLXW/JazcmZ
# VIhNgqUAXcmx50LhXIRGb2xSTKWMq937KJF5EaATJCMHaD+8Un0qhXV/sa3dpzki
# En6nri96wKNRnmSNKZ9mbnNOcOfdU/A7466xQDmgWa4k7INY/HSbBV4ZmrjjPruv
# pRnNilIx5jq5+IPzdmBlJiFaO75aqYyf6rWZtfMxEWeaYB3+/H9YLMUd+RQyZVyA
# S4WFTeplle1jfRkXwWnDhThGUuG1T02xNS4ABpbBwAh8eCVNq5bB+5Amot4sKe0W
# KosVkrlZ2lBQD3rLBCQlgNQerJX8Q0Mr7kXOA7WKtbb2jbent6smKSb6MPG6rwSD
# UydhueEqYTS4sdOBzQlrZGp3hj1OhmCKQSx7j2WVxw1gCA8rgTqCHN30ZywfSuOJ
# nPBLnAP+/65dERyaVLpV4RYSGeiYgHpTaoLdf+GN0UWpm0hpYxBUvNBHvFNoSbwH
# m4WaAdc9HRJYmp0IX/UKVMySyD4GUVdGIoNupABZAAJB2xLyeRy0PQ6vuJByRa+b
# dsLznGrkFgogmXXwXsdb7XrEeDBydFWwFHKVmQaG9Cd6AvyiSuJxv7RjzrXHs3X8
# +Hu+vvjKcbN6HvGef1wbDKIRZxmJVjBgDLnI8VkNLh92oGS47E2mfV0W2PS799af
# EUpwFtHsFbD0vq8pozmY9ZobhiahggQEMIIEAAYJKoZIhvcNAQkGMYID8TCCA+0C
...
# Gj4FxdMwPwYJKoZIhvcNAQkEMTIEMO8waY5pp8s7509WEHowmXx8n09zzHJVNOHS
# XGosJ9DU+LSJiA8aRUl6RB0Yb3c8bTCBoAYLKoZIhvcNAQkQAgwxgZAwgY0wgYow
...
# hvcNAQEBBQAEggIARMN6SrsJShqbF79Vta6AbiQYZ+81PRcwVesAaATdCo46R83Z
# PGiPYRf5FD8G2tabM0hoHYNThSS+trgyvwMsAiajGTS8UJ2EmjhrXmxRsXMMOMnh
# 8zjSfdjv7Qybmj+eUaNr4DEQ3LQIu1sJAfl/k+ftL9Jy9qEeguWBbihBTWrCcY0n
# d1bfvqXxINhuviX4LvQDWqe4aBislbcU43QedGqSwLKyOro2yZEWrwBgctBuZR/u
# PbdQKobDmg8p8bOn0S8Bwi+IQq71Yj83nXMN6AwvFym8/jNI3+9MU3w8i3XAOUel
# JeKvY7GFs3V4ZGkor3hpcZMFU4hCuU61z7pkMsnEK6SdrVKgLRaNjeM/60ABO8JV
# ykKedttq5HqsNQjb7X5Eafd1aa1QmOEvEIeuwM78K6YhAiMYeSGzm5AMf5/fMxGN
# JTTQBPPZ0Q0niOKzc/vPSwvOX0dyWm1iGq6d8MXuQPpS+JT8bOJy2wLIRVL7a24J
# iY10LIjQj3vasfObaLvaFgv4+heDBYGiEr/R6Wuy7PDbyL43ye/XuvUwNFFS1nM2
# Zc6njFTkix3csqsjF+MEOoN+1CI405INIgJK0UWLcQQSRt/eQBYkW08fBxOLeXIf
# oYfnu3E12SDNC7Dta9hQ34+TreBbLLT/+s71btMbS/bs8vACSjX/tefLfXg=
